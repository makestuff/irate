...
static const USB_Descriptor_HIDReport_Datatype_t PROGMEM kbReport[] = {
...
static const ConfigDescriptor PROGMEM configDescriptor = {
  ...
  .hidKeyboard = {
    ...
    .HIDReportLength        = sizeof(kbReport)
  },
  ...
  const uint16_t wValue, const uint16_t wIndex, const void** const descAddress)
{
  ...
  case HID_DTYPE_HID:
    *descAddress = &configDescriptor.hidKeyboard;
    return sizeof(USB_HID_Descriptor_HID_t);
    
  case HID_DTYPE_Report:
    *descAddress = &kbReport;
    return sizeof(kbReport);
  }
